        ...
        for (c = 0, d = e.registeredEvents[a].length; d > c; c++)
          e.registeredEvents[a][c].func.call(e, b),
            e.registeredEvents[a][c].oneTime &&
              (e.registeredEvents[a].splice(c, 1),
  ...
  (function (a, b, c, d) {
    ...
    (e["private"] = {
       ...
       */ browserInfo: function () {
        ...
        -1 !== h.indexOf("MSIE 8.") // ie8
          ? (g.browser = "ie8")
          : -1 !== h.indexOf("MSIE 9.") // ie9
          ? (g.browser = "ie9")
          : -1 !== h.indexOf("MSIE 10.") // ie10
          ? (g.browser = "ie10")
          : b.ActiveXObject || "ActiveXObject" in b // ie11
          ? (g.browser = "ie11")
          : /android/gi.test(h) // android
          ? (g.browser = "android")
          : /iphone|ipad|ipod/gi.test(h) // ios
          ? (g.browser = "ios")
          : /chrome/gi.test(h)
          ? (g.browser = "chrome")
          : (g.browser = ""),
    ...
    a.extend(e.prototype, {
      ...
      destroySlider: function () {
        ...
        "slider" === b.options.layoutMode &&
          ...
          b.$ul.off(".cbp"),
          a(c).off(".cbp"), // @todo - don't interfer with the lightbox
            ...
            a(c).on("keydown.cbp", function (a) {
              ...
              b.isOpen &&
                ...
                (b.stopEvents ||
                  ...
                  37 === a.keyCode // prev key
                    ? b.prev()
                    : 39 === a.keyCode // next key
                    ? b.next()
                    : 27 === a.keyCode && //esc key
                      b.close()));
            });
        },
